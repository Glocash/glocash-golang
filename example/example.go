...
func main() {
	...
	// embed payment
	embedParam := map[string]string{
		"d-currency":  "USD",
		"d-price":     "30",
		"d-invoice":   strconv.FormatInt(time.Now().Unix(), 10),
		"d-email":     "Custom email input here",
		"d-sandbox":   "1",
		"title":       "Button display name",
		"class":       " Button style class",
		"d-goodsname": "DEFAULT GOODS",
		"d-method":    "C01",
		"d-success":   "Sync returned result url",
		"d-pending":   "Sync payment pending returned url",
		"d-notify":    "Async notification payment status url",
		"d-failed":    "Transaction failed url",
	}
	script := g.PayEmbed(embedParam)
	if script != "" {
		// Insert this script code into your html sale page proper place
	}
	...
	if g.NotifySign(post) != post["REQ_SIGN"] {
		// Sign error
	}
}
